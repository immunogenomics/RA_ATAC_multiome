...
parser <- ArgumentParser(description='Make ArchR project and infer doublets in peak space')
...
#cell QC and Tn5 trimming were already done on these fragments
